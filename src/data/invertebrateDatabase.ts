...
export const INVERTEBRATE_DATABASE: Invertebrate[] = [
  ...
  },
  {
    ...
    minTankSize: 30,
    temperatureRange: [72, 80],
    description: 'Small urchin with alternating blue and black bands and short, non-threatening spines. One of the best algae grazers available and safe to handle.',
  ...
  },
  {
    ...
    minTankSize: 40,
    temperatureRange: [72, 80],
    description: 'The most popular aquarium giant clam — vivid mantle in blue, purple, gold, and multicolor morphs. Filter-feeds and photosynthesizes. A living jewel.',
    careNotes: 'Needs very high light — place near the top of the tank. Requires stable calcium (400–450 ppm), alkalinity, and magnesium for shell growth. Needs iodide supplementation. Clamps shut if stressed — do not place near aggressive fish or sea stars.',
    emoji: '💎',
  },
  {
    id: 'tiger-cowrie',
    ...
    minTankSize: 30,
    temperatureRange: [72, 80],
    description: 'Iconic dome-shaped snail with a glossy white shell covered in dark spots. The soft mantle wraps around the polished shell when active. Large and bold.',
    careNotes: 'NOT reef-safe — eats soft corals, polyps, and clams. Best kept in FOWLR tanks. Grazes on algae and organic detritus. Hardy and long-lived. Active mostly at night. A classic marine invertebrate.',
    cleaningRole: 'Grazes algae and detritus in FOWLR systems.',
    emoji: '🐆',
  },
  {
    id: 'sexy-anemone-crab',
    name: 'Porcelain Anemone Crab',
    scientificName: 'Neopetrolisthes ohshimai',
    invertType: 'crab',
    tankType: ['saltwater', 'reef'],
    ...
    minTankSize: 10,
    temperatureRange: [72, 80],
    description: 'White crab with vivid red spots that lives commensally within anemones. Waves feathery feeding fans to filter plankton. Peaceful and attractive.',
    careNotes: 'Reef-safe. Pairs best with a host anemone (carpet, bubble tip) but will adapt to live without one. Filter feeds with fan-like maxillipeds — supplement with liquid reef foods. Peaceful; compatible with most reef inhabitants.',
    emoji: '🌸',
  },
  {
    id: 'halloween-hermit',
    ...
    minTankSize: 20,
    temperatureRange: [72, 80],
    description: 'Striking orange legs with white bands — Halloween colors in a hermit crab. One of the most visually interesting hermit crabs for the reef tank.',
    careNotes: 'Reef-safe with caution — like all hermits, may harass snails for their shells. Provide empty shells larger than its current one. Larger than dwarf hermits; keep away from very small snails. Scavenges effectively.',
    cleaningRole: 'Scavenges detritus, uneaten food, and algae from the sandbed and rocks.',
    emoji: '🎃',
  },
];
