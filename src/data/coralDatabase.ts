...
export const CORAL_DATABASE: Coral[] = [
  ...
  },
  {
    ...
    scientificName: 'Goniopora lobata',
    coralType: 'lps',
    difficulty: 'advanced',
    lightRequirement: 'medium',
    flowRequirement: 'medium',
    placement: 'bottom',
    aggressiveness: 'peaceful',
    description: 'Colonies of long-stalked polyps that extend dramatically, resembling a bouquet of flowers. Green, pink, and purple morphs exist. Visually stunning when fully open.',
    careNotes: 'One of the more challenging LPS — historically had a poor survival record but captive-bred aquacultured specimens are significantly more hardy. Needs supplemental feeding with coral foods. Give it space — polyp extension is wide.',
    emoji: '💐',
  },
  {
    id: 'leptoseris',
    name: 'Leptoseris (Lettuce Coral)',
    scientificName: 'Leptoseris sp.',
    coralType: 'sps',
    difficulty: 'intermediate',
    ...
    placement: 'top',
    aggressiveness: 'peaceful',
    description: 'Thin, plating SPS coral with fine surface texture resembling lettuce leaves. Comes in purple, green, and tan morphs. Plates can grow very large over time.',
    careNotes: 'Tolerates a wider range of light than many SPS. Mount on a flat surface or allow to plate naturally over the rockscape. Stable parameters required for growth. One of the more forgiving plating SPS species.',
    emoji: '🥬',
  },
  {
    id: 'caulastrea',
    ...
    placement: 'middle',
    aggressiveness: 'peaceful',
    description: 'Colonial LPS with round, striped heads in green and teal that resemble candy canes when fully extended. Heads divide and multiply steadily over time.',
    careNotes: 'One of the best beginner LPS — tolerant of parameter swings and does not require pristine conditions. Feeds readily on meaty foods. Peaceful and non-aggressive. A great starting point for LPS keepers.',
    emoji: '🍬',
  },
  {
    id: 'sinularia',
  ...
  },
  {
    ...
    placement: 'bottom',
    aggressiveness: 'aggressive',
    description: 'Dense colony of sharp, star-shaped corallites with translucent polyps tipped in white or green. One of the most aggressive coral species — extends sweeper tentacles over 12 inches at night.',
    careNotes: 'Give at least 12 inches of space in all directions — sweeper tentacles will sting and kill neighboring corals. Hardy once established. Does not need to be fed directly. A beautiful but demanding neighbor.',
    emoji: '⭐',
  },
  {
    id: 'wellsophyllia',
    name: 'Open Brain Coral',
    scientificName: 'Wellsophyllia radiata',
    coralType: 'lps',
    difficulty: 'beginner',
    lightRequirement: 'low',
    flowRequirement: 'low',
    placement: 'bottom',
    aggressiveness: 'semi-aggressive',
    description: 'Large, fleshy single-polyp coral with a brain-like folded surface. Comes in vivid reds, greens, and blues. Closely related to Trachyphyllia and equally colorful.',
    careNotes: 'Place directly on the sandbed in low flow. Expands dramatically after lights dim — leave extra space. Feeds on meaty foods a few times a week. One of the most colorful and beginner-friendly LPS corals.',
    emoji: '🧠',
  },
  {
    id: 'montipora-undata',
    name: 'Montipora Undata',
    scientificName: 'Montipora undata',
    coralType: 'sps',
    difficulty: 'intermediate',
    lightRequirement: 'high',
    flowRequirement: 'high',
    placement: 'top',
    aggressiveness: 'peaceful',
    description: 'Plating Montipora with a distinctive wave-like surface texture and contrasting polyp and base colors — often purple plates with green polyps or vice versa.',
    careNotes: 'One of the more visually distinctive Montipora species. Plates need stable alkalinity to grow well. Position where it gets good flow across the surface. Peels apart if parameter swings occur.',
    emoji: '🌊',
  },
  {
    id: 'turbinaria',
    name: 'Turbinaria (Cup Coral)',
    ...
    placement: 'middle',
    aggressiveness: 'peaceful',
    description: 'Yellow-green plating or cup-shaped coral with distinctive upturned edges and small corallites. Unusual form factor compared to most LPS. Hardy and slow-growing.',
    careNotes: 'One of the hardier LPS options. The cup shape can collect detritus — provide moderate flow to keep it clean. Does not need direct feeding but benefits from occasional meaty foods. Tolerates lower light than many LPS.',
    emoji: '🏆',
  },
  {
    id: 'euphyllia-ancora',
    name: 'Hammer Coral (Branching)',
    scientificName: 'Euphyllia ancora',
    coralType: 'lps',
    difficulty: 'beginner',
    lightRequirement: 'medium',
    ...
    placement: 'middle',
    aggressiveness: 'semi-aggressive',
    description: 'Popular Euphyllia with hammer or anchor-shaped polyp tips that sway gracefully in flow. Available in green, gold, and ultra-colored morphs.',
    careNotes: 'One of the best starter LPS — hardy and forgiving. Compatible with other Euphyllia species. Has sweeper tentacles but shorter than Galaxea. Feed meaty foods weekly for best growth. Strong flow may irritate polyps.',
    emoji: '🔨',
  },
];
